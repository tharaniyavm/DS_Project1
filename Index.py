...
with col1:
    ...
    skills = ["Python", "Pandas", "SQL", "Streamlit", "Data Science", "Data Cleaning","Data Engineering"]
...
with st.expander("📖 Read Project Abstract"):
    st.write("""
        ...
        By leveraging **SQLLite** for data storage and **Pandas** for processing, the system provides 
